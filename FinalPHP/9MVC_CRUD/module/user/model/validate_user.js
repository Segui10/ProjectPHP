...
function validate(){
    ...
    if(!r_sisop){
        document.getElementById('error_sisop').innerHTML = " * El sistema operativo introducido no es valido";
        check=false;
    }else{
        document.getElementById('error_sisop').innerHTML = "";
    }
    if(!r_marca){
        document.getElementById('error_marca').innerHTML = " * La marca introducido no es valido";
        check=false;
    }else{
    ...
    if(!r_sty){
        document.getElementById('error_sty').innerHTML = " * El tipo de pantalla introducido no es valido";
        check=false;
    }else{
        document.getElementById('error_sty').innerHTML = "";
    }
    if(!r_pro){
        document.getElementById('error_pro').innerHTML = " * El procesador introducido no es valido";
        check=false;
    }else{
        document.getElementById('error_pro').innerHTML = "";
    }
    if(!r_core){
        document.getElementById('error_core').innerHTML = " * El procesador introducido no es valido";
        check=false;
    }else{
        document.getElementById('error_core').innerHTML = "";
    }
    if(!r_speed){
        document.getElementById('error_speed').innerHTML = " * El procesador introducido no es valido";
        check=false;
    }else{
    ...
    if(!r_antutu){
        document.getElementById('error_antutu').innerHTML = " * El texto introducido no es valido";
        check=false;
    }else{
